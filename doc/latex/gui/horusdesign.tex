...
En el esquema se presentan todos los módulos del paquete que
contiene el sistema HORUS, los cuales se detallan a continuación:
...
\item Módulo \emph{data}: Contiene los datos de configuración del
  ...
  configuraciones, entre otros. Los datos contenidos en este módulo sirven
  como insumo para la funcionalidad de algunas rutinas y deben estar
  muy bien estructurados para facilidad de lectura y manipulación.

\item Módulo \emph{doc}: Básicamente contiene los manuales técnicos y
  de usuario, así como archivos en diferentes formatos (html, pdf,
  entre otros) que explican la funcionalidad de submódulos o rutinas.
...
\item Módulo \emph{ext data}: Este módulo representa la base de datos
  de imágenes instantáneas, time exposure, variance o timestacks, de
  las zonas de estudio, así como las series de tiempo, e información
  sobre la estación. La línea punteada del recuadro indica que no se
  encuentra dentro del paquete de HORUS, pero hay comunicación con
  este módulo.
