...
botón correspondiente en la interfaz principal de HORUS o escribiendo
el comando \verb!gui_configure_database! en la línea de comandos de
...
\item Apply configuration: Este botón ejecuta la configuración creando
  ...
  administrador. Desde aquí es posible insertar información en la base
...
\subsubsection{Configuración de una nueva base de datos}
