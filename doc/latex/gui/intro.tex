...
estación, pero en forma general, se fusionan las imágenes oblicuas y
se fusionan las imágenes rectificadas de tipo \textit{snap} y
\textit{timex} y se generan miniaturas de estas imágenes. A medida que
se van generando las nuevas imágenes, éstas son insertadas en la base
de datos satélite, para luego ser enviadas al \textit{hosting}.
\\
...
fusionar imágenes oblicuas, fusionar imágenes rectificadas de tipo
\textit{snap} y \textit{timex}, generar miniaturas de estas imágenes,
y se configuran los datos para transferir las miniaturas al
\textit{hosting}. Las imágenes generadas son insertadas en S1 y las miniaturas son enviadas al \textit{hosting}.
...
los adecuados y que no haya solapes. Estos tiempos se calculan con las
siguientes fórmulas:
