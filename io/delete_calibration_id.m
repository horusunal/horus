function  [varargout] = delete_calibration_id(conn, station, idcalibration)

%DELETE_CALIBRATION_ID this function is used for removing a calibration.
%
%   Input:
...
%
%   Example:
%   status = delete_calibration_id(conn, 'CARTAGENA', 'CRTG00000')
%
