function  [varargout] = delete_imagetype(conn, station)

%DELETE_IMAGETYPE this function is used for removing all image types from a
% station.
%
%   Input:
%   conn: Database connection which must have been previously created.
%   station: station where all imagetypes are to be removed.
%
%   Output:
...
%
%   Example:
%   status = delete_imagetype(conn, 'CARTAGENA')
%
...
try
    ...
    try
        ...
        query = ['DELETE FROM imagetype_' station ...
