...
try
    ...
    try
        query = ['SELECT idcalibration, gp.id, '...
            ...
            'FROM calibration_' lower(station) ' c '...
            'JOIN calibrationparameter_' lower(station) ' gp '...
            'JOIN calibrationvalue_' lower(station) ' pv '...
            ...
            'ORDER BY timestamp DESC, idcalibration DESC LIMIT 0,1)'
            ];
