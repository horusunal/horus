    ...
    try
        switch datat
            ...
            case 'merge_rectified'
                query = ['SELECT i.timestamp FROM image_' lower(station) ' AS i NATURAL '...
                    'JOIN mergedimage_' lower(station) ' AS mi JOIN fusion_' lower(station) ' AS f JOIN camerabyfusion_' lower(station) ' AS cf '...
