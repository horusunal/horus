function  data  = load_sensor_station(conn, station)

%LOAD_SENSOR_STATION this function is used for querying all
%                 the sensors in the station.
%
%   Input:
...
%
%   Output:
%   data: cell array with the sensor names.
%
%   Example:
%   data  = load_sensor_station(conn, 'CARTAGENA');
%
