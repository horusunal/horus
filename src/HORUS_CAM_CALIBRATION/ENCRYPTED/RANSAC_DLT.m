function [H UVend XYZend pos]=RANSAC_DLT(u,v,x,y,z)
%
% [H UVend XYZend pos]=RANSAC_DLT(u,v,x,y,z)
% This function calculates the DLT as presented in Pérez (2009) and Pérez
...
% Pérez (2009). The DLT, H satisfies the condition h31^2+h32^2+h33^2=1.
% Inputs:
